...
function DefaultDragHandle() {
  return (
    <div className="tei-drag-handle flex h-6 w-6 cursor-grab items-center justify-center rounded opacity-0 transition-opacity hover:opacity-100 active:cursor-grabbing">
      <svg
        width="14"
        height="14"
        viewBox="0 0 24 24"
 ...
 * Shows a grip handle on hover near the left edge of blocks.
 */
