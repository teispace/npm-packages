...
export class ProvidersService {
  async generateRootProvider(projectPath: string, answers: ProjectPrompts): Promise<void> {
...
`;
  ...
  async generateLayout(projectPath: string, answers: ProjectPrompts): Promise<void> {
    if (!answers.i18n) {
